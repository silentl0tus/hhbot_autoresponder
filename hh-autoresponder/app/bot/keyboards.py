...
OPENROUTER_MODELS = [
    ("openrouter/auto", "🤖 Умный авто-рутер (Автоматически)"),
    ("anthropic/claude-3.5-sonnet", "🧠 Claude 3.5 Sonnet (Качество)"),
    ("openai/gpt-4o", "🚀 GPT-4o (Баланс)"),
    ("openai/gpt-4o-mini", "⚡️ GPT-4o-mini (Скорость)"),
